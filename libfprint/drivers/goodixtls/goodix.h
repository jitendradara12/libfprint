...
/**
 * @brief Stale-activation guard generation.
 *
 * Counter bumped on (re)activation start and teardown; TLS completion
 * callbacks drop on mismatch without touching hardware.
 *
 * @param dev
